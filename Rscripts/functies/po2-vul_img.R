  ...
  # Organisatie kenmerk
  #
  printheading("Kenmerk","Kritieke succesfactor: Organisatiekenmerk",rvnaam,f1vnaam,f2vnaam,"head-orgkenmerk.png")
  ...
  # Effect
  #
  printheading("Effect","Kritieke succesfactor: Organisatie effect",rvnaam,f1vnaam,f2vnaam,"head-effect.png")
