  ...
  # Organisatie kenmerk
  #
  print1heading("Kenmerk","Kritieke succesfactor: Organisatiekenmerk",rvnaam,"head-orgkenmerk.png")
  ...
  # Effect
  #
  print1heading("Effect","Kritieke succesfactor: Organisatie effect",rvnaam,"head-effect.png")
  ...
  # Vitaliteit
  #
  print1heading("Specials","Kritieke vitaliteitsfactoren",rvnaam,"head-vitaal.png")
  ...
  # Duurzaamheid
  #
  print1heading("Specials","Kritieke veranderfactoren",rvnaam,"head-duurzaam.png")
  ...
  # Transformatie
  #
  print1heading("Specials","Kritieke transformatiefactoren",rvnaam,"head-transformatie.png")
  ...
  # Prestatie
  #
  print1heading("Specials","Kritieke prestatiefactoren",rvnaam,"head-prestatie.png")
  ...
  # Waarden
  #
  print1heading("Specials","Kritieke waarden factoren",rvnaam,"head-waarden.png")
