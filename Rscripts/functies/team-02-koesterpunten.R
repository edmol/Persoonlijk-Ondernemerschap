...
teamprintheading("Koesterpunten","Mate van ondernemendheid van het team","TEAM",t1naam,t2naam,"ko.png")
teamprintheading("Koesterpunten","Mate van betrokkenheid van het team","TEAM",t1naam,t2naam,"kb.png")
teamprintheading("Ontwikkelpunten","Mate van ondernemendheid van het team","TEAM",t1naam,t2naam,"oo.png")
teamprintheading("Ontwikkelpunten","Mate van betrokkenheid van het team","TEAM",t1naam,t2naam,"ob.png")
#
