...
#
y <- c(rrx,f1x,f2x,f3x,f4x,f5x,f6x,f7x)
x <- c(rry,f1y,f2y,f3y,f4y,f5y,f6y,f7y)
#
...
#
legend(0,104, c("team",t1naam,t2naam,t3naam,t4naam,t5naam,t6naam,t7naam),
       cex=2.5,  horiz=TRUE,
       text.col=c("green","red","blue","gray","black","yellow","orange","pink"))
#
