...
#
f3x=c(100-f3results[101],100-f3results[104],100-f3results[107],100-f3results[110],100-f3results[113],100-f3results[116],
     100-f3results[119],100-f3results[122],100-f3results[125],100-f3results[128])
f3y=c(f3results[102],f3results[105],f3results[108],f3results[111],f3results[114],f3results[117],
     f3results[120],f3results[123],f3results[126],f3results[129])
#
f4x=c(100-f4results[101],100-f4results[104],100-f4results[107],100-f4results[110],100-f4results[113],100-f4results[116],
     100-f4results[119],100-f4results[122],100-f4results[125],100-f4results[128])
f4y=c(f4results[102],f4results[105],f4results[108],f4results[111],f4results[114],f4results[117],
...
#
legend(0,104, c(rvnaam,f1vnaam,f2vnaam,f3vnaam,f4vnaam),
       cex=2.5,  horiz=TRUE,
       text.col=c("green","blue","orange","purple","black"))
#
...
f3x=c(100-f3results[131],100-f3results[140],100-f3results[134],100-f3results[137],100-f3results[143])
f4x=c(100-f4results[131],100-f4results[140],100-f4results[134],100-f4results[137],100-f4results[143])
#
...
f3y=c(f3results[132],f3results[141],f3results[135],f3results[138],f3results[144])
f4y=c(f4results[132],f4results[141],f4results[135],f4results[138],f4results[144])
#
y <- c(rrx,f1x,f2x,f3x,f4x)
x <- c(rry,f1y,f2y,f3y,f4y)
#
...
f3x=c(mean(c(100-f3results[101],100-f3results[104],100-f3results[107])),
      mean(c(100-f3results[110],100-f3results[113])),
      mean(c(100-f3results[116],100-f3results[119])),
      mean(c(100-f3results[122],100-f3results[125],100-f3results[128])))
f4x=c(mean(c(100-f4results[101],100-f4results[104],100-f4results[107])),
      mean(c(100-f4results[110],100-f4results[113])),
      mean(c(100-f4results[116],100-f4results[119])),
      mean(c(100-f4results[122],100-f4results[125],100-f4results[128])))
#
...
f3y=c(mean(c(f3results[102],f3results[105],f3results[108])),
      mean(c(f3results[111],f3results[114])),
      mean(c(f3results[117],f3results[120])),
      mean(c(f3results[123],f3results[126],f3results[129])))
f4y=c(mean(c(f4results[102],f4results[105],f4results[108])),
      mean(c(f4results[111],f4results[114])),
      mean(c(f4results[117],f4results[120])),
      mean(c(f4results[123],f4results[126],f4results[129])))
#
y <- c(rrx,f1x,f2x,f3x,f4x)
x <- c(rry,f1y,f2y,f3y,f4y)
#
...
#
legend(0,104, c(rvnaam,f1vnaam,f2vnaam,f3vnaam,f4vnaam),inset=c(-0.18,0),
       cex=2.5, horiz=TRUE,
       text.col=c("green","blue","orange","purple","black"))
#
#abline(h = y[1], col = "blue")
...
f3x=c(0,100-f3results[151],100-f3results[146],100-f3results[153],f3results[156])
f4x=c(0,100-f4results[151],100-f4results[146],100-f4results[153],f4results[156])
#
rry=c(rresults[150],0,rresults[147],0,0)
f1y=c(f1results[150],0,f1results[147],0,0)
f2y=c(f2results[150],0,f2results[147],0,0)
f3y=c(f3results[150],0,f3results[147],0,0)
f4y=c(f4results[150],0,f4results[147],0,0)
#
y <- c(rrx,f1x,f2x,f3x,f4x)
x <- c(rry,f1y,f2y,f3y,f4y)
#
...
for(i in 1 : 6)
{
  if(top_3[i] == 1)
  {
    ...
    f3x[i] <- 100-f3results[101]
    f4x[i] <- 100-f4results[101]
    #
    rry[i] <- rresults[102]
    f1y[i] <- f1results[102]
    f2y[i] <- f2results[102] 
  ...
  if(top_3[i] == 2)
  {
    ...
    f3x[i] <- 100-f3results[104]
    f4x[i] <- 100-f4results[104]
    #
    rry[i] <- rresults[105]
    f1y[i] <- f1results[105]
    f2y[i] <- f2results[105] 
  ...
  if(top_3[i] == 3)
  {
    ...
    f3x[i] <- 100-f3results[107]
    f4x[i] <- 100-f4results[107]
    #
    rry[i] <- rresults[108]
    f1y[i] <- f1results[108]
    f2y[i] <- f2results[108] 
  ...
  if(top_3[i] == 4)
  {
    ...
    f3x[i] <- 100-f3results[110]
    f4x[i] <- 100-f4results[110]
    #
    rry[i] <- rresults[111]
    f1y[i] <- f1results[111]
    f2y[i] <- f2results[111] 
  ...
  if(top_3[i] == 5)
  {
    ...
    f3x[i] <- 100-f3results[113]
    f4x[i] <- 100-f4results[113]
    #
    rry[i] <- rresults[114]
    f1y[i] <- f1results[114]
    f2y[i] <- f2results[114] 
  ...
  if(top_3[i] == 6)
  {
    ...
    f3x[i] <- 100-f3results[116]
    f4x[i] <- 100-f4results[116]
    #
    rry[i] <- rresults[117]
    f1y[i] <- f1results[117]
    f2y[i] <- f2results[117] 
  ...
  if(top_3[i] == 7)
  {
    ...
    f3x[i] <- 100-f3results[119]
    f4x[i] <- 100-f4results[119]
    #
    rry[i] <- rresults[120]
    f1y[i] <- f1results[120]
    f2y[i] <- f2results[120] 
  ...
  if(top_3[i] == 8)
  {
    ...
    f3x[i] <- 100-f3results[122]
    f4x[i] <- 100-f4results[122]
    #
    rry[i] <- rresults[123]
    f1y[i] <- f1results[123]
    f2y[i] <- f2results[123] 
  ...
  if(top_3[i] == 9)
  {
    ...
    f3x[i] <- 100-f3results[125]
    f4x[i] <- 100-f4results[125]
    #
    rry[i] <- rresults[126]
    f1y[i] <- f1results[126]
    f2y[i] <- f2results[126] 
  ...
  if(top_3[i] == 10)
  {
    ...
    f3x[i] <- 100-f3results[128]
    f4x[i] <- 100-f4results[128]
    #
    rry[i] <- rresults[129]
    f1y[i] <- f1results[129]
    f2y[i] <- f2results[129] 
  ...
  if(top_3[i] == 11)
  {
    ...
    f3x[i] <- 100-f3results[131]
    f4x[i] <- 100-f4results[131]
    #
    rry[i] <- rresults[132]
    f1y[i] <- f1results[132]
    f2y[i] <- f2results[132] 
  ...
  if(top_3[i] == 12)
  {
    ...
    f3x[i] <- 100-f3results[134]
    f4x[i] <- 100-f4results[134]
    #
    rry[i] <- rresults[135]
    f1y[i] <- f1results[135]
    f2y[i] <- f2results[135] 
  ...
  if(top_3[i] == 13)
  {
    ...
    f3x[i] <- 100-f3results[137]
    f4x[i] <- 100-f4results[137]
    #
    rry[i] <- rresults[138]
    f1y[i] <- f1results[138]
    f2y[i] <- f2results[138] 
  ...
  if(top_3[i] == 14)
  {
    ...
    f3x[i] <- 100-f3results[140]
    f4x[i] <- 100-f4results[140]
    #
    rry[i] <- rresults[141]
    f1y[i] <- f1results[141]
    f2y[i] <- f2results[141] 
  ...
  if(top_3[i] == 15)
  {
    ...
    f3x[i] <- 100-f3results[143]
    f4x[i] <- 100-f4results[143]
    #
    rry[i] <- rresults[144]
    f1y[i] <- f1results[144]
    f2y[i] <- f2results[144] 
  ...
  if(top_3[i] == 16)
  {
    ...
    f3x[i] <- 100-f3results[146]
    f4x[i] <- 100-f4results[146]
    #
    rry[i] <- rresults[147]
    f1y[i] <- f1results[147]
    f2y[i] <- f2results[147] 
  ...
  if(top_3[i] == 18)
  {
    ...
    f3x[i] <- 100-f3results[151]
    f4x[i] <- 100-f4results[151]
    #
    rry[i] <- 0
    f1y[i] <- 0
    f2y[i] <- 0 
  ...
  if(top_3[i] == 19)
  {
    ...
    f3x[i] <- 100-f3results[153]
    f4x[i] <- 100-f4results[153]
    #
    rry[i] <- 0
    f1y[i] <- 0
    f2y[i] <- 0 
  ...
  if(top_3[i] == 20)
  {
    ...
    f3x[i] <- 100-f3results[155] 
    f4x[i] <- 100-f4results[155]
    #
  }
  #
}
