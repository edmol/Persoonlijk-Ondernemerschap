...
#
f5x=c(100-t5results[101],100-t5results[104],100-t5results[107],100-t5results[110],100-t5results[113],100-t5results[116],
      100-t5results[119],100-t5results[122],100-t5results[125],100-t5results[128])
f5y=c(t5results[102],t5results[105],t5results[108],t5results[111],t5results[114],t5results[117],
      t5results[120],t5results[123],t5results[126],t5results[129])
#
f6x=c(100-t6results[101],100-t6results[104],100-t6results[107],100-t6results[110],100-t6results[113],100-t6results[116],
      100-t6results[119],100-t6results[122],100-t6results[125],100-t6results[128])
f6y=c(t6results[102],t6results[105],t6results[108],t6results[111],t6results[114],t6results[117],
      t6results[120],t6results[123],t6results[126],t6results[129])
#
f7x=c(100-t7results[101],100-t7results[104],100-t7results[107],100-t7results[110],100-t7results[113],100-t7results[116],
      100-t7results[119],100-t7results[122],100-t7results[125],100-t7results[128])
f7y=c(t7results[102],t7results[105],t7results[108],t7results[111],t7results[114],t7results[117],
      t7results[120],t7results[123],t7results[126],t7results[129])
#
f8x=c(100-t8results[101],100-t8results[104],100-t8results[107],100-t8results[110],100-t8results[113],100-t8results[116],
      100-t8results[119],100-t8results[122],100-t8results[125],100-t8results[128])
f8y=c(t8results[102],t8results[105],t8results[108],t8results[111],t8results[114],t8results[117],
      t8results[120],t8results[123],t8results[126],t8results[129])
#
y <- c(rrx,f1x,f2x,f3x,f4x,f5x,f6x,f7x,f8x)
x <- c(rry,f1y,f2y,f3y,f4y,f5y,f6y,f7y,f8y)
#
...
#
legend(0,104, c("team",t1naam,t2naam,t3naam,t4naam,t5naam,t6naam,t7naam,t8naam),
       cex=2.5,  horiz=TRUE,
       text.col=c("green","red","blue","gray","black","yellow","orange","pink","violet"))
#
...
f5x=c(100-t5results[131],100-t5results[140],100-t5results[134],100-t5results[137],100-t5results[143])
f6x=c(100-t6results[131],100-t6results[140],100-t6results[134],100-t6results[137],100-t6results[143])
f7x=c(100-t7results[131],100-t7results[140],100-t7results[134],100-t7results[137],100-t7results[143])
f8x=c(100-t8results[131],100-t8results[140],100-t8results[134],100-t8results[137],100-t8results[143])
#
...
f5y=c(t5results[132],t5results[141],t5results[135],t5results[138],t5results[144])
f6y=c(t6results[132],t6results[141],t6results[135],t6results[138],t6results[144])
f7y=c(t7results[132],t7results[141],t7results[135],t7results[138],t7results[144])
f8y=c(t8results[132],t8results[141],t8results[135],t8results[138],t8results[144])
#
y <- c(rrx,f1x,f2x,f3x,f4x,f5x,f6x,f7x,f8x)
x <- c(rry,f1y,f2y,f3y,f4y,f5y,f6y,f7y,f8y)
#
...
f5x=c(mean(c(100-t5results[101],100-t5results[104],100-t5results[107])),
      mean(c(100-t5results[110],100-t5results[113])),
      mean(c(100-t5results[116],100-t5results[119])),
      mean(c(100-t5results[122],100-t5results[125],100-t5results[128])))
f6x=c(mean(c(100-t6results[101],100-t6results[104],100-t6results[107])),
      mean(c(100-t6results[110],100-t6results[113])),
      mean(c(100-t6results[116],100-t6results[119])),
      mean(c(100-t6results[122],100-t6results[125],100-t6results[128])))
f7x=c(mean(c(100-t7results[101],100-t7results[104],100-t7results[107])),
      mean(c(100-t7results[110],100-t7results[113])),
      mean(c(100-t7results[116],100-t7results[119])),
      mean(c(100-t7results[122],100-t7results[125],100-t7results[128])))
f8x=c(mean(c(100-t8results[101],100-t8results[104],100-t8results[107])),
      mean(c(100-t8results[110],100-t8results[113])),
      mean(c(100-t8results[116],100-t8results[119])),
      mean(c(100-t8results[122],100-t8results[125],100-t8results[128])))
#
...
f5y=c(mean(c(t5results[102],t5results[105],t5results[108])),
      mean(c(t5results[111],t5results[114])),
      mean(c(t5results[117],t5results[120])),
      mean(c(t5results[123],t5results[126],t5results[129])))
f6y=c(mean(c(t6results[102],t6results[105],t6results[108])),
      mean(c(t6results[111],t6results[114])),
      mean(c(t6results[117],t6results[120])),
      mean(c(t6results[123],t6results[126],t6results[129])))
f7y=c(mean(c(t7results[102],t7results[105],t7results[108])),
      mean(c(t7results[111],t7results[114])),
      mean(c(t7results[117],t7results[120])),
      mean(c(t7results[123],t7results[126],t7results[129])))
f8y=c(mean(c(t8results[102],t8results[105],t8results[108])),
      mean(c(t8results[111],t8results[114])),
      mean(c(t8results[117],t8results[120])),
      mean(c(t8results[123],t8results[126],t8results[129])))
...
f5x=c(0,100-t5results[151],100-t5results[146],100-t5results[153],t5results[156])
f6x=c(0,100-t6results[151],100-t6results[146],100-t6results[153],t6results[156])
f7x=c(0,100-t7results[151],100-t7results[146],100-t7results[153],t7results[156])
f8x=c(0,100-t8results[151],100-t8results[146],100-t8results[153],t8results[156])
#
...
f5y=c(t5results[150],0,t5results[147],0,0)
f6y=c(t6results[150],0,t6results[147],0,0)
f7y=c(t7results[150],0,t7results[147],0,0)
f8y=c(t8results[150],0,t8results[147],0,0)
#
y <- c(rrx,f1x,f2x,f3x,f4x,f5x,f6x,f7x,f8x)
x <- c(rry,f1y,f2y,f3y,f4y,f5y,f6y,f7y,f8y)
#
...
for(i in 1 : 6)
{
  if(top_3[i] == 1)
  {
    ...
    f5x[i] <- 100-t5results[101]
    f6x[i] <- 100-t6results[101]
    f7x[i] <- 100-t7results[101]
    f8x[i] <- 100-t8results[101]
    #
    rry[i] <- team[102]
    f1y[i] <- t1results[102]
    f2y[i] <- t2results[102] 
  ...
  if(top_3[i] == 2)
  {
    ...
    f5x[i] <- 100-t5results[104]
    f6x[i] <- 100-t6results[104]
    f7x[i] <- 100-t7results[104]
    f8x[i] <- 100-t8results[104]
    #
    rry[i] <- team[105]
    f1y[i] <- t1results[105]
    f2y[i] <- t2results[105] 
  ...
  if(top_3[i] == 3)
  {
    ...
    f5x[i] <- 100-t5results[107]
    f6x[i] <- 100-t6results[107]
    f7x[i] <- 100-t7results[107]
    f8x[i] <- 100-t8results[107]
    #
    rry[i] <- team[108]
    f1y[i] <- t1results[108]
    f2y[i] <- t2results[108] 
  ...
  if(top_3[i] == 4)
  {
    ...
    f5x[i] <- 100-t5results[110]
    f6x[i] <- 100-t6results[110]
    f7x[i] <- 100-t7results[110]
    f8x[i] <- 100-t8results[110]
    #
    rry[i] <- team[111]
    f1y[i] <- t1results[111]
    f2y[i] <- t2results[111] 
  ...
  if(top_3[i] == 5)
  {
    ...
    f5x[i] <- 100-t5results[113]
    f6x[i] <- 100-t6results[113]
    f7x[i] <- 100-t7results[113]
    f8x[i] <- 100-t8results[113]
    #
    rry[i] <- team[114]
    f1y[i] <- t1results[114]
    f2y[i] <- t2results[114] 
  ...
  if(top_3[i] == 6)
  {
    ...
    f5x[i] <- 100-t5results[116]
    f6x[i] <- 100-t6results[116]
    f7x[i] <- 100-t7results[116]
    f8x[i] <- 100-t8results[116]
    #
    rry[i] <- team[117]
    f1y[i] <- t1results[117]
    f2y[i] <- t2results[117] 
  ...
  if(top_3[i] == 7)
  {
    ...
    f5x[i] <- 100-t5results[119]
    f6x[i] <- 100-t6results[119]
    f7x[i] <- 100-t7results[119]
    f8x[i] <- 100-t8results[119]
    #
    rry[i] <- team[120]
    f1y[i] <- t1results[120]
    f2y[i] <- t2results[120] 
  ...
  if(top_3[i] == 8)
  {
    ...
    f5x[i] <- 100-t5results[122]
    f6x[i] <- 100-t6results[122]
    f7x[i] <- 100-t7results[122]
    f8x[i] <- 100-t8results[122]
    #
    rry[i] <- team[123]
    f1y[i] <- t1results[123]
    f2y[i] <- t2results[123] 
  ...
  if(top_3[i] == 9)
  {
    ...
    f5x[i] <- 100-t5results[125]
    f6x[i] <- 100-t6results[125]
    f7x[i] <- 100-t7results[125]
    f8x[i] <- 100-t8results[125]
    #
    rry[i] <- team[126]
    f1y[i] <- t1results[126]
    f2y[i] <- t2results[126] 
  ...
  if(top_3[i] == 10)
  {
    ...
    f5x[i] <- 100-t5results[128]
    f6x[i] <- 100-t6results[128]
    f7x[i] <- 100-t7results[128]
    f8x[i] <- 100-t8results[128]
    #
    rry[i] <- team[129]
    f1y[i] <- t1results[129]
    f2y[i] <- t2results[129] 
  ...
  if(top_3[i] == 11)
  {
    ...
    f5x[i] <- 100-t5results[131]
    f6x[i] <- 100-t6results[131]
    f7x[i] <- 100-t7results[131]
    f8x[i] <- 100-t8results[131]
    #
    rry[i] <- team[132]
    f1y[i] <- t1results[132]
    f2y[i] <- t2results[132] 
  ...
  if(top_3[i] == 12)
  {
    ...
    f5x[i] <- 100-t5results[134]
    f6x[i] <- 100-t6results[134]
    f7x[i] <- 100-t7results[134]
    f8x[i] <- 100-t8results[134]
    #
    rry[i] <- team[135]
    f1y[i] <- t1results[135]
    f2y[i] <- t2results[135] 
  ...
  if(top_3[i] == 13)
  {
    ...
    f5x[i] <- 100-t5results[137]
    f6x[i] <- 100-t6results[137]
    f7x[i] <- 100-t7results[137]
    f8x[i] <- 100-t8results[137]
    #
    rry[i] <- team[138]
    f1y[i] <- t1results[138]
    f2y[i] <- t2results[138] 
  ...
  if(top_3[i] == 14)
  {
    ...
    f5x[i] <- 100-t5results[140]
    f6x[i] <- 100-t6results[140]
    f7x[i] <- 100-t7results[140]
    f8x[i] <- 100-t8results[140]
    #
    rry[i] <- team[141]
    f1y[i] <- t1results[141]
    f2y[i] <- t2results[141] 
  ...
  if(top_3[i] == 15)
  {
    ...
    f5x[i] <- 100-t5results[143]
    f6x[i] <- 100-t6results[143]
    f7x[i] <- 100-t7results[143]
    f8x[i] <- 100-t8results[143]
    #
    rry[i] <- team[144]
    f1y[i] <- t1results[144]
    f2y[i] <- t2results[144] 
  ...
  if(top_3[i] == 16)
  {
    ...
    f5x[i] <- 100-t5results[146]
    f6x[i] <- 100-t6results[146]
    f7x[i] <- 100-t7results[146]
    f8x[i] <- 100-t8results[146]
    #
    rry[i] <- team[147]
    f1y[i] <- t1results[147]
    f2y[i] <- t2results[147] 
  ...
  if(top_3[i] == 18)
  {
    ...
    f5x[i] <- 100-t5results[151]
    f6x[i] <- 100-t6results[151]
    f7x[i] <- 100-t7results[151]
    f8x[i] <- 100-t8results[151]
    #
    rry[i] <- 0
    f1y[i] <- 0
    f2y[i] <- 0 
  ...
  if(top_3[i] == 19)
  {
    ...
    f5x[i] <- 100-t5results[153]
    f6x[i] <- 100-t6results[153]
    f7x[i] <- 100-t7results[153]
    f8x[i] <- 100-t8results[153]
    #
    rry[i] <- 0
    f1y[i] <- 0
    f2y[i] <- 0 
  ...
  if(top_3[i] == 20)
  {
    ...
    f5x[i] <- 100-t5results[155]
    f6x[i] <- 100-t6results[155]
    f7x[i] <- 100-t7results[155]
    f8x[i] <- 100-t8results[155]
    #
  }
  #
}
