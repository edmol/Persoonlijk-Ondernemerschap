  ...
  #
  print1heading("Leiderschap","1. Regenboog zien",rvnaam,f1vnaam,"head-stap1.png")
  print1heading("Leiderschap","2. Regie voeren",rvnaam,f1vnaam,"head-stap2.png")
  print1heading("Leiderschap","3. Richting vaststellen",rvnaam,f1vnaam,"head-stap3.png")
  print1heading("Zeggenschap","4. Rust geven",rvnaam,f1vnaam,"head-stap4.png")
  print1heading("Zeggenschap","5. Ruimte creeren",rvnaam,f1vnaam,"head-stap5.png")
  print1heading("Vakmanschap","6. Rendement vaststellen",rvnaam,f1vnaam,"head-stap6.png")
  print1heading("Vakmanschap","7. Resultaat boeken",rvnaam,f1vnaam,"head-stap7.png")
  print1heading("Vakmanschap","8. Reflectie vragen/geven",rvnaam,f1vnaam,"head-stap8.png")
  print1heading("Beterschap","9. Relaties houden",rvnaam,f1vnaam,"head-stap9.png")
  print1heading("Beterschap","10. Ruggengraat tonen",rvnaam,f1vnaam,"head-stap10.png") 
  ...
  # Gevoel
  #
  print1heading("Gevoel","Kritische succes en faalfactor: Gevoel",rvnaam,f1vnaam,"head-gevoel.png")
  ...
  # Houding
  #
  print1heading("Houding","Kritische succes en faalfactor: Houding",rvnaam,f1vnaam,"head-houding.png")
  ...
  # Organisatie kenmerk
  #
  print1heading("Organisatiekenmerk","Kritische succes en faalfactor: Organisatiekenmerk",rvnaam,f1vnaam,"head-orgkenmerk.png")
  ...
  # Gedrag
  #
  print1heading("Gedrag","Kritische succes en faalfactor: Gedrag",rvnaam,f1vnaam,"head-gedrag.png")
  ...
  # Effect
  #
  print1heading("Effect","Kritische succes en faalfactor: Effect",rvnaam,f1vnaam,"head-effect.png")
  ...
  g_range <- range(0,sum01$resp,sum01$f1)
  ...
  title(main=maintitle, col.main="blue", font.main=7,cex.main=2)
  legend(1, 10, c(rvnaam,f1vnaam), cex=0.8, 
  ...
  # LIne plot voorbereiden
  g_range <- range(0,sum02$resp,sum02$f1)
