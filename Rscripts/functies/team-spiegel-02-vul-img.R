  ...
  # Organisatie kenmerk
  #
  teamprintheading("Kenmerk","Kritieke succesfactor: Organisatiekenmerk","TEAM",t1naam,t2naam,"head-orgkenmerk.png")
  ...
  # Effect
  #
  teamprintheading("Effect","Kritieke succesfactor: Organisatie effect","TEAM",t1naam,t2naam,"head-effect.png")
