...
lines(sum01$t5, type="o",lwd=2, pch=4, lty=4, col="yellow")
title(main=maintitle, col.main="black", font.main=7, cex.main=2)
legend(1, 100, c(rvnaam,f1vnaam,f2vnaam,f3vnaam,f4vnaam),
       cex=1.3, horiz=TRUE, 
...
sum01 <- data.frame(factor=c("Houding","Gedrag","Gevoel","Beeld","Uiting"),
                    ...
                    t5=c(f4results[133],f4results[142],f4results[136],f4results[139],f4results[145])
)
#
# Nu sorteren van hoog naar laag op Groeipotentieel
#
