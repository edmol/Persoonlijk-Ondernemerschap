teamprintheading <- function(dimensie,stap,n1,n2,n3,n4,n5,filename)
{
  ...
  usr <- par("usr")
  plot.new()
  text(usr[1],usr[3],dimensie,adj = c(0,-0.3),col="black",cex=1.8)
  plot.new()
  ...
  plot.new()
  text(usr[1],usr[3],n5,adj = c(0,-0.3),col="black",cex=1.8)
  graphics.off()
}
