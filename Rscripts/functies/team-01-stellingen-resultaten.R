  ...
  # Beeld
  #
  teamprintheading("Kenmerk","Kritieke succesfactor: Beeld","TEAM",t1naam,"head-orgkenmerk.png")
  ...
  # Effect
  #
  teamprintheading("Effect","Kritieke succesfactor Uiting","TEAM",t1naam,"head-effect.png")
