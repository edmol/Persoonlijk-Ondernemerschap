  ...
  # Organisatie kenmerk
  #
  teamprintheading("Kenmerk","Kritieke succesfactor: Organisatiekenmerk","TEAM",t1naam,t2naam,t3naam,t4naam,t5naam,t6naam,t7naam,"head-orgkenmerk.png")
  ...
  # Effect
  #
  teamprintheading("Effect","Kritieke succesfactor: Organisatie effect","TEAM",t1naam,t2naam,t3naam,t4naam,t5naam,t6naam,t7naam,"head-effect.png")
  ...
  legend(1, 100, c(t1naam,t2naam,t3naam,t4naam,t5naam,t6naam,t7naam),
         cex=1.25, horiz=TRUE,
         col=c("red","blue","gray","brown","yellow","orange","pink"),
