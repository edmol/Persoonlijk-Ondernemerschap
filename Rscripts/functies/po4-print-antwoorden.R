teamprintantwoorden <- function(vraagnummer,s1,s2,s3,s4,s5,a1,a2,a3,a4,a5,prefix)
{
  if (a1 == 1 ) {r1_lab <- 'n'}
  if (a1 == 2 ) {r1_lab <- 'i'}
  if (a1 == 3 ) {r1_lab <- 's'}
  ...
  plot.new()
  text(usr[1],usr[3],vraag[vraagnummer],adj = c(0,-0.3),col=txtcol,cex=1.6)
  barplot(r1,horiz=TRUE,col=barcol,axes=FALSE,las=2)
  text(0,0.5,labels=c(r1_lab),pos=4,cex=1.6)
  barplot(r2,horiz=TRUE,col=barcol,axes=FALSE,las=2)
  text(0,0.5,labels=c(r2_lab),pos=4,cex=1.6)
  barplot(r3,horiz=TRUE,col=barcol,axes=FALSE,las=2)
  text(0,0.5,labels=c(r3_lab),pos=4,cex=1.6)
  barplot(r4,horiz=TRUE,col=barcol,axes=FALSE,las=2)
  text(0,0.5,labels=c(r4_lab),pos=4,cex=1.6)
  barplot(r5,horiz=TRUE,col=barcol,axes=FALSE,las=2)
  text(0,0.5,labels=c(r5_lab),pos=4,cex=1.6)
  graphics.off() 
}
