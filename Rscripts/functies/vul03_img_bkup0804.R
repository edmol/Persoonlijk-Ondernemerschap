  ...
  #
  teamprintheading("1. Regenboog",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap1.png")
  teamprintheading("2. Regie",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap2.png")
  teamprintheading("3. Richting",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap3.png")
  teamprintheading("4. Rust",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap4.png")
  teamprintheading("5. Ruimte",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap5.png")
  teamprintheading("6. Rendement",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap6.png")
  teamprintheading("7. Resultaten",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap7.png")
  teamprintheading("8. Reflectie",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap8.png")
  teamprintheading("9. Relaties",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap9.png")
  teamprintheading("10. Ruggengraat",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-stap10.png") 
  ...
  teamprintsumm("o","1a",rresults[101],f1results[101],f2results[101],f3results[101])
  teamprintsumm("b","1b",rresults[102],f1results[102],f2results[102],f3results[102])
  teamprintsumm("g","1c",rresults[103],f1results[103],f2results[103],f3results[103])
  img[111] <- paste(folder,'summ1a.png',sep="") 
  img[112] <- paste(folder,'summ1b.png',sep="")
  img[113] <- paste(folder,'summ1c.png',sep="")
  #
  teamprintsumm("o","2a",rresults[104],f1results[104],f2results[104],f3results[104])
  teamprintsumm("b","2b",rresults[105],f1results[105],f2results[105],f3results[105])
  teamprintsumm("g","2c",rresults[106],f1results[106],f2results[106],f3results[106])
  img[114] <- paste(folder,'summ2a.png',sep="") 
  img[115] <- paste(folder,'summ2b.png',sep="")
  img[116] <- paste(folder,'summ2c.png',sep="")
  #
  teamprintsumm("o","3a",rresults[107],f1results[107],f2results[107],f3results[107])
  teamprintsumm("b","3b",rresults[108],f1results[108],f2results[108],f3results[108])
  teamprintsumm("g","3c",rresults[109],f1results[109],f2results[109],f3results[109])
  img[117] <- paste(folder,'summ3a.png',sep="") 
  img[118] <- paste(folder,'summ3b.png',sep="")
  img[119] <- paste(folder,'summ3c.png',sep="")
  #
  teamprintsumm("o","4a",rresults[110],f1results[110],f2results[110],f3results[110])
  teamprintsumm("b","4b",rresults[111],f1results[111],f2results[111],f3results[111])
  teamprintsumm("g","4c",rresults[112],f1results[112],f2results[112],f3results[112])
  img[120] <- paste(folder,'summ4a.png',sep="") 
  img[121] <- paste(folder,'summ4b.png',sep="")
  img[122] <- paste(folder,'summ4c.png',sep="")
  #
  teamprintsumm("o","5a",rresults[113],f1results[113],f2results[113],f3results[113])
  teamprintsumm("b","5b",rresults[114],f1results[114],f2results[114],f3results[114])
  teamprintsumm("g","5c",rresults[115],f1results[115],f2results[115],f3results[115])
  img[123] <- paste(folder,'summ5a.png',sep="") 
  img[124] <- paste(folder,'summ5b.png',sep="")
  img[125] <- paste(folder,'summ5c.png',sep="")
  #
  teamprintsumm("o","6a",rresults[116],f1results[116],f2results[116],f3results[116])
  teamprintsumm("b","6b",rresults[117],f1results[117],f2results[117],f3results[117])
  teamprintsumm("g","6c",rresults[118],f1results[118],f2results[118],f3results[118])
  img[126] <- paste(folder,'summ6a.png',sep="") 
  img[127] <- paste(folder,'summ6b.png',sep="")
  img[128] <- paste(folder,'summ6c.png',sep="")
  #
  teamprintsumm("o","7a",rresults[119],f1results[119],f2results[119],f3results[119])
  teamprintsumm("b","7b",rresults[120],f1results[120],f2results[120],f3results[120])
  teamprintsumm("g","7c",rresults[121],f1results[121],f2results[121],f3results[121])
  img[129] <- paste(folder,'summ7a.png',sep="") 
  img[130] <- paste(folder,'summ7b.png',sep="")
  img[131] <- paste(folder,'summ7c.png',sep="")
  #
  teamprintsumm("o","8a",rresults[122],f1results[122],f2results[122],f3results[122])
  teamprintsumm("b","8b",rresults[123],f1results[123],f2results[123],f3results[123])
  teamprintsumm("g","8c",rresults[124],f1results[124],f2results[124],f3results[124])
  img[132] <- paste(folder,'summ8a.png',sep="") 
  img[133] <- paste(folder,'summ8b.png',sep="")
  img[134] <- paste(folder,'summ8c.png',sep="")
  #
  teamprintsumm("o","9a",rresults[125],f1results[125],f2results[125],f3results[125])
  teamprintsumm("b","9b",rresults[126],f1results[126],f2results[126],f3results[126])
  teamprintsumm("g","9c",rresults[127],f1results[127],f2results[127],f3results[127])
  img[135] <- paste(folder,'summ9a.png',sep="") 
  img[136] <- paste(folder,'summ9b.png',sep="")
  img[137] <- paste(folder,'summ9c.png',sep="")
  #
  teamprintsumm("o","10a",rresults[128],f1results[128],f2results[128],f3results[128])
  teamprintsumm("b","10b",rresults[129],f1results[129],f2results[129],f3results[129])
  teamprintsumm("g","10c",rresults[130],f1results[130],f2results[130],f3results[130])
  ...
  # Gevoel
  #
  teamprintheading("GEVOEL",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-gevoel.png")
  img[141] <- paste(folder,'head-gevoel.png',sep="")
  teamprintsumm("o","-gevoel-a",rresults[134],f1results[134],f2results[134],f3results[134])
  teamprintsumm("b","-gevoel-b",rresults[135],f1results[135],f2results[135],f3results[135])
  teamprintsumm("g","-gevoel-c",rresults[136],f1results[136],f2results[136],f3results[136])
  ...
  # Houding
  #
  teamprintheading("HOUDING",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-houding.png")
  img[145] <- paste(folder,'head-houding.png',sep="")
  teamprintsumm("o","-houding-a",rresults[131],f1results[131],f2results[131],f3results[131])
  teamprintsumm("b","-houding-b",rresults[132],f1results[132],f2results[132],f3results[132])
  teamprintsumm("g","-houding-c",rresults[133],f1results[133],f2results[133],f3results[133])
  ...
  # Organisatie kenmerk
  #
  teamprintheading("Organisatie kenmerk",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-orgkenmerk.png")
  img[149] <- paste(folder,'head-orgkenmerk.png',sep="")
  teamprintsumm("o","okenmerka",rresults[137],f1results[137],f2results[137],f3results[137])
  teamprintsumm("b","okenmerkb",rresults[138],f1results[138],f2results[138],f3results[138])
  teamprintsumm("g","okenmerkc",rresults[139],f1results[139],f2results[139],f3results[139])
  ...
  # Gedrag
  #
  teamprintheading("GEDRAG",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-gedrag.png")
  img[153] <- paste(folder,'head-gedrag.png',sep="")
  teamprintsumm("o","gedraga",rresults[140],f1results[140],f2results[140],f3results[140])
  teamprintsumm("b","gedragb",rresults[141],f1results[141],f2results[141],f3results[141])
  teamprintsumm("g","gedragc",rresults[142],f1results[142],f2results[142],f3results[142])
  ...
  # Effect
  #
  teamprintheading("EFFECT",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-effect.png")
  img[157] <- paste(folder,'head-effect.png',sep="")
  teamprintsumm("o","effecta",rresults[143],f1results[143],f2results[143],f3results[143])
  teamprintsumm("b","effectb",rresults[144],f1results[144],f2results[144],f3results[144])
  teamprintsumm("g","effectc",rresults[145],f1results[145],f2results[145],f3results[145])
  ...
  # Vitaliteit
  #
  teamprintheading("VITALITEIT",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-vitaal.png")
  img[161] <- paste(folder,'head-vitaal.png',sep="")
  teamprintsumm("v1","vitaal1",rresults[149],f1results[149],f2results[149],f3results[149])
  teamprintsumm("v2","vitaal2",rresults[150],f1results[150],f2results[150],f3results[150])
  img[162] <- paste(folder,'summvitaal1.png',sep="")
  img[163] <- paste(folder,'summvitaal2.png',sep="")
  #
  # Duurzaamheid
  #
  teamprintheading("DUURZAAM",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-duurzaam.png")
  img[164] <- paste(folder,'head-duurzaam.png',sep="")
  teamprintsumm("c1","duurzaam1",rresults[151],f1results[151],f2results[151],f3results[151])
  teamprintsumm("c2","duurzaam2",rresults[152],f1results[152],f2results[152],f3results[152])
  img[165] <- paste(folder,'summduurzaam1.png',sep="")
  img[166] <- paste(folder,'summduurzaam2.png',sep="")
  #
  # Transformatie
  #
  teamprintheading("Transformatie",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-transformatie.png")
  img[167] <- paste(folder,'head-transformatie.png',sep="")
  teamprintsumm("o","transformatiea",rresults[146],f1results[146],f2results[146],f3results[146])
  teamprintsumm("b","transformatieb",rresults[147],f1results[147],f2results[147],f3results[147])
  teamprintsumm("g","transformatiec",rresults[148],f1results[148],f2results[148],f3results[148])
  ...
  # Prestatie
  #
  teamprintheading("Prestatie",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-prestatie.png")
  img[171] <- paste(folder,'head-prestatie.png',sep="")
  teamprintsumm("o","prestatiea",rresults[153],f1results[153],f2results[153],f3results[153])
  teamprintsumm("g","prestatieb",rresults[154],f1results[154],f2results[154],f3results[154])
  img[172] <- paste(folder,'summprestatiea.png',sep="")
  img[173] <- paste(folder,'summprestatieb.png',sep="")
  #
  # Waarden
  #
  teamprintheading("Waarden",rvnaam,f1vnaam,f2vnaam,f3vnaam,"head-waarden.png")
  img[174] <- paste(folder,'head-waarden.png',sep="")
  teamprintsumm("o","waardena",rresults[155],f1results[155],f2results[155],f3results[155])
  teamprintsumm("g","waardenb",rresults[156],f1results[156],f2results[156],f3results[156])
  ...
  plot(sum01$t1,type="o",lty=1,col="green",ylim=g_range,axes=FALSE,ann=TRUE,xlab="",ylab="Jouw mate van ondernemendheid")
  ...
  legend(1, 20, c(rvnaam,f1vnaam,f2vnaam,f3vnaam),
         cex=0.8, 
  ...
  # LIne plot voorbereiden
  g_range <- range(0,sum01$t1,sum01$t2,sum01$t3,sum01$t4)
  plot(sum01$t1,type="o",col="green",ylim=g_range,axes=FALSE,ann=TRUE,xlab="",ylab="Jouw mate van betrokkenheid")
  axis(1,at=1:10,labels = FALSE)
  axis(2, las=1,at=5*0:g_range[2])
  text(1:10, par("usr")[3] - 2, srt = 45, adj = 1,
     labels = sum01$factor, col=c("blue"), xpd = TRUE, cex=0.8)  
  ...
  # LIne plot voorbereiden
  g_range <- range(0,sum01$t1,sum01$t2,sum01$t3,sum01$t4)
  plot(sum02$t1,type="o",col="green",ylim=g_range,axes=FALSE,ann=TRUE,xlab="",ylab="Mogelijke groei percentage")
  axis(1,at=1:10,labels = FALSE)
  axis(2, las=1,at=5*0:g_range[2])
  text(1:10, par("usr")[3] - 2, srt = 45, adj = 1,
     labels = sum01$factor, col=c("blue"), xpd = TRUE, cex=0.8)  
  ...
  legend(1, 5, c(rvnaam,f1vnaam,f2vnaam,f3vnaam),
         cex=0.8, 
         col=c("green","blue","orange","purple"),
         pch=c(15,1,2,3))
  dev.off()
  ...
  # 
  sum01 <- data.frame(factor=c("Gevoel","Houding","Organisatie kenmerk","Gedrag","Effect"),
  ...
  plot(sum02$t1,type="o",col="green",ylim=g_range,axes=FALSE,ann=TRUE,xlab="",ylab="% ontwikkel potentieel")
  ...
  lines(sum02$t4, type="o", pch=3, lty=3, col="purple")
  title(main=maintitle, col.main="black", font.main=4)
  legend(1, 10, c(rvnaam,f1vnaam,f2vnaam,f3vnaam),
         cex=0.8, 
         col=c("green","blue","orange","purple"),
         pch=c(15,1,2,3))
  dev.off()
