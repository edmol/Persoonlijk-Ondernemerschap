...
#                     BEREKENINGEN TE MAKEN. ALLE RESULTATEN NAAR EXTRENE USER MAP
#                     survey = 21391 - 100 stellingen van respondent en 2 feedbackgevers
#                     Tokens van feedbackgevers opgenomen in token van respondent
#                     dus alleen respondenten mogen verwerkt worden, maar alle resultaten moeten 
#                     wel naar de historie database.
#
#
# Database variabelen
#
...
# ------------------------------------------------------------------------------------------------
# inlezen van de datafile toets-po-cockpit.csv 
...
#
meannum = nrow(dbGetQuery(historiedb,statement=paste('select * from ',resulttable,sep="")))
# ------------------------------------------------------------------------------------------------
...
for(i in 1 : finalnum){
  ...
  #  Opslaan info uit token record omdat bepaald moet wordenin welke file de resultaten opgeslagen moeten worden.
  ...
  #
  # volgend statement kan verwaarend zijn. Als het een respondent is dan is het het token van
  # de tweede feedback gever
  #
  ...
  #
  # filename = staat al in de database en is aangemaakt. Alle feedbackgevers hebben dezelfde directory z  
  ...
  #
  eindresultaat <- matrix(1:156,ncol=1)
  ...
  # 
  # nu kunnen het eindresultaat voor de vragen gaan opmaken
  #
  for(vraag in 1:100)
  {
    if (antwoord[vraag]==nooit) {eindresultaat[vraag] <- vraag_waarden_nooit[vraag]}
    if (antwoord[vraag]==incidenteel) {eindresultaat[vraag] <- vraag_waarden_incidenteel[vraag]}
    if (antwoord[vraag]==soms) {eindresultaat[vraag] <- vraag_waarden_soms[vraag]}
    if (antwoord[vraag]==meestal) {eindresultaat[vraag] <- vraag_waarden_meestal[vraag]}
    if (antwoord[vraag]==altijd) {eindresultaat[vraag] <- vraag_waarden_altijd[vraag]}
  }
  # 
  ...
  {    
    ...
    eindresultaat[startpos+1] <- round(mean(c(eindresultaat[stelling+1],
                                     eindresultaat[stelling+3],
                                     eindresultaat[stelling+5],
                                     eindresultaat[stelling+7],
                                     eindresultaat[stelling+9])),0)
    eindresultaat[startpos+2] <- round((200-eindresultaat[startpos]-eindresultaat[startpos+1])/2,0)
    startpos <- startpos + 3
  }
...
startpos <- 131
    eindresultaat[startpos] <- round(mean(c(eindresultaat[1],                                            
                                            ...
                                            eindresultaat[81],
                                            eindresultaat[91])),0)
    eindresultaat[startpos+1] <- round(mean(c(eindresultaat[2],                                            
                                            eindresultaat[12],                                            
                                            eindresultaat[22],                                            
                                            eindresultaat[32],                                            
                                            eindresultaat[42],                                            
...
startpos <- 134
  eindresultaat[startpos] <- round(mean(c(eindresultaat[3],                                            
                                          ...
                                          eindresultaat[83],
                                          eindresultaat[93])),0)
  eindresultaat[startpos+1] <- round(mean(c(eindresultaat[4],                                            
                                            eindresultaat[14],                                            
                                            eindresultaat[24],                                            
                                            eindresultaat[34],                                            
                                            eindresultaat[44],                                            
...
startpos <- 137
  eindresultaat[startpos] <- round(mean(c(eindresultaat[5],                                            
                                          ...
                                          eindresultaat[85],
                                          eindresultaat[95])),0)
  eindresultaat[startpos+1] <- round(mean(c(eindresultaat[6],                                            
                                            eindresultaat[16],                                            
                                            eindresultaat[26],                                            
                                            eindresultaat[36],                                            
                                            eindresultaat[46],                                            
...
startpos <- 140
  eindresultaat[startpos] <- round(mean(c(eindresultaat[7],                                            
                                          ...
                                          eindresultaat[87],
                                          eindresultaat[97])),0)
  eindresultaat[startpos+1] <- round(mean(c(eindresultaat[8],                                            
                                            eindresultaat[18],                                            
                                            eindresultaat[28],                                            
                                            eindresultaat[38],                                            
                                            eindresultaat[48],                                            
...
startpos <- 143
  eindresultaat[startpos] <- round(mean(c(eindresultaat[9],                                            
                                          ...
                                          eindresultaat[89],
                                          eindresultaat[99])),0)
  eindresultaat[startpos+1] <- round(mean(c(eindresultaat[10],                                            
                                            eindresultaat[20],                                            
                                            eindresultaat[30],                                            
                                            eindresultaat[40],                                            
                                            eindresultaat[50],                                            
...
#####################################################################################################  
  ...
  #
  # Gebruik dit statement om de data weer in te lezen
  # as.matrix(read.table(bestand))
  #
  ...
  if(file.exists(f1)){
    if(file.exists(f2)) {
      ...
      {
        gereed <- tokenset[i,20]
      }
      # 
      # Nu de text file aanmaken en in de juiste folder zetten
      #
      dirtoken <- gereed
      folder <- paste(dirgraph,dirtoken,'/',sep="")
      setwd(folder)
      sweavefile <- paste(functie_map,"po-rapport.Rnw",sep="")
      Sweave(sweavefile)      
    }
}
}
