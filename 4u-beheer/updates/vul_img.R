  ...
  #
  printheading("Leiderschap","1. Denken vanuit het groter geheel",rvnaam,f1vnaam,f2vnaam,"head-stap1.png")
  printheading("Leiderschap","2. Sturen vanuit positief zelfvertrouwen.",rvnaam,f1vnaam,f2vnaam,"head-stap2.png")
  printheading("Leiderschap","3. Wat wil jij? Ben je hier duidelijk over?",rvnaam,f1vnaam,f2vnaam,"head-stap3.png")
  printheading("Zeggenschap","4. Afstand nemen en pas op de plaats maken.",rvnaam,f1vnaam,f2vnaam,"head-stap4.png")
  printheading("Zeggenschap","5. Loslaten, veilig en vertrouwd voelen.",rvnaam,f1vnaam,f2vnaam,"head-stap5.png")
  printheading("Vakmanschap","6. Doelstellingen behalen, verantwoordelijkheid nemen.",rvnaam,f1vnaam,f2vnaam,"head-stap6.png")
  printheading("Vakmanschap","7. Kun/wil je veranderen? Welke hulp roep je in?",rvnaam,f1vnaam,f2vnaam,"head-stap7.png")
  printheading("Vakmanschap","8. Kwetsbaar opstellen en open zijn over je gevoel.",rvnaam,f1vnaam,f2vnaam,"head-stap8.png")
  printheading("Beterschap","9. Relaties aangaan en onderhouden.",rvnaam,f1vnaam,f2vnaam,"head-stap9.png")
  printheading("Beterschap","10. Volledig en volhardend zijn, gedisciplineerdheid.",rvnaam,f1vnaam,f2vnaam,"head-stap10.png") 
  ...
  # Gevoel
  #
  printheading("GEVOEL","Wat denk je en zie je bij jezelf? Bespreekbaar maken.",rvnaam,f1vnaam,f2vnaam,"head-gevoel.png")
  ...
  # Houding
  #
  printheading("HOUDING","Sta je bewust stil waar je mee bezig bent?",rvnaam,f1vnaam,f2vnaam,"head-houding.png")
  ...
  # Organisatie kenmerk
  #
  printheading("ORGANISATIE KENMERKEN","Gewenste verandering - zijn bekend en geaccepteerd.",rvnaam,f1vnaam,f2vnaam,"head-orgkenmerk.png")
  ...
  # Gedrag
  #
  printheading("GEDRAG","Openlijk aangeven wat belangrijk en waardevol is.",rvnaam,f1vnaam,f2vnaam,"head-gedrag.png")
  ...
  # Effect
  #
  printheading("EFFECT","Vormgeven van persoonlijk ondernemerschap.",rvnaam,f1vnaam,f2vnaam,"head-effect.png")
  ...
  # Vitaliteit
  #
  printheading("VITALITEIT","Vitaal zijn is een keuze!",rvnaam,f1vnaam,f2vnaam,"head-vitaal.png")
  ...
  # Duurzaamheid
  #
  printheading("DUURZAAM","Randvoorwaarden voor duurzame verandering",rvnaam,f1vnaam,f2vnaam,"head-duurzaam.png")
  ...
  # Transformatie
  #
  printheading("Transformatie","Omstandigheden en omgevingsbewust.",rvnaam,f1vnaam,f2vnaam,"head-transformatie.png")
  ...
  # Prestatie
  #
  printheading("Prestatie","Prestatie- en resultaat-gerichtheid.",rvnaam,f1vnaam,f2vnaam,"head-prestatie.png")
  ...
  # Waarden
  #
  printheading("Waarden","Bewegen vanuit je natuurlijke rol en eigenwaarden.",rvnaam,f1vnaam,f2vnaam,"head-waarden.png")
  ...
  plot(sum01$resp,type="o",pch=22,col="darkblue",ylim=g_range,axes=FALSE,ann=TRUE,xlab="PO stappen",ylab="Jouw mate van ondernemendheid")
  ...
  box()
  lines(sum01$f1, type="o", pch=23, lty=2, col="red")
  lines(sum01$f2, type="o", pch=24, lty=2, col="black")
  title(main=maintitle, col.main="blue", font.main=4)
  legend(4, 10, c(rvnaam,f1vnaam,f2vnaam), cex=0.8, 
         col=c("darkblue","red","black"),pch=22:24, lty=1:2)
  dev.off()
  #
  ...
  # LIne plot voorbereiden
  g_range <- range(0,sum01$resp,sum01$f1,sum01$f2)
  plot(sum01$resp,type="o",pch=22,col="orange",ylim=g_range,axes=FALSE,ann=TRUE,xlab="PO stappen",ylab="Jouw mate van betrokkenheid")
  axis(1,at=1:10,labels = FALSE)
  axis(2, las=1,at=5*0:g_range[2])
  text(1:10, par("usr")[3] - 2, srt = 45, adj = 1,
     labels = sum01$factor, col=c("orange"), xpd = TRUE, cex=0.8)
  box()
  lines(sum01$f1, type="o", pch=23, lty=2, col="red")
  lines(sum01$f2, type="o", pch=24, lty=2, col="black")
  title(main=maintitle, col.main="orange", font.main=4)
  legend(4,10, c(rvnaam,f1vnaam,f2vnaam), cex=0.8, 
         col=c("orange","red","black"), pch=22:24, lty=1:2)
  dev.off()
  #
  ...
  sum02 <- sum01[with(sum01, order(-resp)),]
  maintitle <- paste(rvnaam,'\' s (gewenst) groeipotentieel op PO factoren',sep='')
  # LIne plot voorbereiden
  g_range <- range(0,sum02$resp,sum02$f1,sum02$f2)
  plot(sum02$resp,type="o",pch=22,col="darkblue",ylim=g_range,axes=FALSE,ann=TRUE,xlab="PO stappen",ylab="Mogelijke groei percentage")
  axis(1,at=1:10,labels = FALSE)
  axis(2, las=1,at=5*0:g_range[2])
  text(1:10, par("usr")[3] - 2, srt = 45, adj = 1,
     labels = sum02$factor, col=c("green"), xpd = TRUE, cex=0.8)
  box()
  lines(sum02$f1, type="o", pch=23, lty=2, col="red")
  lines(sum02$f2, type="o", pch=24, lty=2, col="black")
  ...
  # LIne plot voorbereiden
  g_range <- range(0,sum02$resp,sum02$f1,sum02$f2)
  plot(sum02$resp,type="o",pch=22,col="darkblue",ylim=g_range,axes=FALSE,ann=TRUE,xlab="Gevoel, Houding, Organisatie, Gedrag en Effect",ylab="Mogelijke groei percentage")
  ...
  lines(sum02$f2, type="o", pch=24, lty=2, col="black")
  title(main=maintitle, col.main="black", font.main=4)
  legend(3,10, c(rvnaam,f1vnaam,f2vnaam), cex=0.8, 
         col=c("darkblue","red","black"), pch=22:24, lty=1:2)
  dev.off()
  #
  ...
  # LIne plot voorbereiden
  g_range <- range(0,sum02$resp,sum02$f1,sum02$f2)
  plot(sum02$resp,type="o",pch=22,col="darkblue",ylim=g_range,axes=FALSE,ann=TRUE,xlab="Dimensies",ylab="Mogelijke groei percentage")
  ...
  #
  sum01 <- data.frame(factor=c("Vitaliteit","Verandercapaciteit","Omgevingsbewust","Presteren","Waarden"),
  ...
  # LIne plot voorbereiden
  g_range <- range(0,sum02$resp,sum02$f1,sum02$f2)
  plot(sum02$resp,type="o",pch=22,col="darkblue",ylim=g_range,axes=FALSE,ann=TRUE,xlab="Kritieke factoren",ylab="Mogelijke groei percentage")
  axis(1,at=1:5,labels = FALSE)
  axis(2, las=1,at=5*0:g_range[2])
  text(1:5, par("usr")[3] - 2, srt = 45, adj = 1,
     labels = sum02$factor, col=c("green"), xpd = TRUE, cex=0.8)
