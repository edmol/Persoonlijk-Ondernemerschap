...
// The orinal setup file upon which MFG was based.
...
// $db =  strlen($_POST['db']>0) ? @$_POST['db'] : '';
// $tb =  strlen($_POST['tb']>0) ? @$_POST['tb'] : '';
$db = array_key_exists('db', @$_POST) ? trim(stripslashes(strip_tags(@$_POST['db']))) : '';
