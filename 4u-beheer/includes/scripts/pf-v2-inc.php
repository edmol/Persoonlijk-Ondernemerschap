...
$file0 = $dir.'po0_pf-v2-00.tex';
$file = $dir.'po2_pf-v2-02.tex';
$file2 = $dir.'po1_pf-v2-01.tex';
$file3 =$dir.'po3_pf-v2-03.tex';
$file4 =$dir.'po4_pf-v2-04.tex';
$newname = $dirtoken.'-v2-.pdf';
...
if(file_exists($file0))
	{
		...
		//
		system("pdflatex po0_pf-v2-00.tex >/dev/null");
		system("pdflatex po0_pf-v2-00.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po0_pf-v2-00.pdf", $newname);
		//
	...
	if(file_exists($file))
	{
		...
		// Twee keer pdflatex om de toc goed in het document te krijgen
		//
		system("pdflatex po2_pf-v2-02.tex >/dev/null");
		system("pdflatex po2_pf-v2-02.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po2_pf-v2-02.pdf", $newname);
		//
		// Rapport heeft nu een nieuwe onderscheidende naam zodat er een kopie gemaakt kan worden
		//
		//system("rm -r *.png");
	...
	if(file_exists($file2))
	{
		...
		// Twee keer pdflatex om de toc goed in het document te krijgen
		//
		system("pdflatex po1_pf-v2-01.tex >/dev/null");
		system("pdflatex po1_pf-v2-01.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po1_pf-v2-01.pdf", $newname);
		//
		// Rapport heeft nu een nieuwe onderscheidende naam zodat er een kopie gemaakt kan worden
		//
		//system("rm -r *.png");
	...
	if(file_exists($file3))
	{
		...
		// Twee keer pdflatex om de toc goed in het document te krijgen
		//
		system("pdflatex po3_pf-v2-03.tex >/dev/null");
		system("pdflatex po3_pf-v2-03.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po3_pf-v2-03.pdf", $newname);
		//
		// Rapport heeft nu een nieuwe onderscheidende naam zodat er een kopie gemaakt kan worden
		//
		//system("rm -r *.png");
	...
	if(file_exists($file4))
	{
		...
		// Twee keer pdflatex om de toc goed in het document te krijgen
		//
		system("pdflatex po4_pf-v2-04.tex >/dev/null");
		system("pdflatex po4_pf-v2-04.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po4_pf-v2-04.pdf", $newname);
		//
		// Rapport heeft nu een nieuwe onderscheidende naam zodat er een kopie gemaakt kan worden
		//
		//system("rm -r *.png");
