...
// Suggested filename: my_afdeling.php
// Tue, 26 Feb 2013 11:08:31 +0100
...
$opts['key'] = 'afd_id'; // Primary key checked

$opts['key_type'] = 'int';

$opts['sort_field'] = array('afd_id');
...
CREATE TABLE `afdeling` (
  `afd_id` int(11) NOT NULL AUTO_INCREMENT,
  `afd_naam` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `afd_manager` int(11) DEFAULT NULL,
  `afd_aantal` int(4) DEFAULT NULL,
  `afd_org` int(11) DEFAULT NULL,
  `afd_telefoon` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `afd_plaats` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `afd_secretaresse` int(11) DEFAULT NULL,
  PRIMARY KEY (`afd_id`)
...
$main_table = 'afdeling';
$main_column = 'afd_org_id';
$join_table = 'organisatie';
$join_column = 'org_id';
$join_description = 'org_naam';


$opts['fdd']['afd_naam'] = array(
//  'colattrs|LF'   => '',
  'default'    => '',
  'help|ACP'   => 'Afdeling',
  'input'      => '',
