...
// Suggested filename: my_medewerkers.php
// Tue, 26 Feb 2013 14:09:34 +0100
...
$opts['tb'] = 'facilitators';

$opts['key'] = 'fac_id'; // Primary key checked

$opts['key_type'] = 'int';

$opts['sort_field'] = array('fac_id');
...
CREATE TABLE `medewerkers` (
  ...
  `med_organisatie` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_afdeling` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_voornaam` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_achternaam` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_geslacht` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_email` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_functie` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_prive_email` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_telefoon_werk` varchar(11) COLLATE utf8_unicode_ci DEFAULT NULL,
  `med_telefoon_mobiel` varchar(11) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`med_id`)
...
$main_table = 'facilitators';
$main_column = 'fac_organisatie_id';
$join_table = 'organisaties';
$join_column = 'bid';
$join_description = 'bedrijfsnaam';

$opts['fdd']['fac_organisatie'] = array(
  'default'    => '',
  'help|ACP'   => 'Organisatie',
  'input'      => '',
  'maxlen'     => 11,
  'name'       => 'Organisatie',
  'values'     => array(
  	...
  	'column'		=> $join_column,
  	'description'	=> array(
  		'columns'	=> array($join_description),
  		'divs'		=> array(' ')
  		)),
  'options'    => 'ACPVDFL',
  'select'     => 'T',
...
// MySQL column 5: string - varchar(1)


$opts['fdd']['fac_email'] = array(
  'default'    => '',
  'help|ACP'   => 'Zakelijk email adres',
  'input'      => '',
  'maxlen'     => 40,
  'name'       => 'Zakelijk Email',
  'required'   => true,
...
$opts['fdd']['fac_email']['URL'] = 'mailto:$value';


$opts['fdd']['fac_functie'] = array(
  'default'    => '',
  'help|ACP'   => 'Functie',
  'input'      => '',
  'maxlen'     => 40,
...
$opts['fdd']['fac_prive_email'] = array(
  'default'    => '',
  'help|ACP'   => 'Prive Email',
  'input'      => '',
  'maxlen'     => 40,
  'name'       => 'Prive Email',
  'required'   => true,
...
$opts['fdd']['fac_prive_email']['URL'] = 'mailto:$value';


$opts['fdd']['fac_telefoon_werk'] = array(
  'default'    => '',
  'help|ACP'   => 'Telefoon Werk',
  'input'      => '',
  'maxlen'     => 11,
  'name'       => 'Telefoon Werk',
  'required'   => true,
...
// MySQL column 9: string - varchar(11)


$opts['fdd']['fac_telefoon_mobiel'] = array(
  'default'    => '',
  'help|ACP'   => 'Mobiel telefoonnummer',
  'input'      => '',
  'maxlen'     => 11,
...
// MySQL column 10: string - varchar(11)
