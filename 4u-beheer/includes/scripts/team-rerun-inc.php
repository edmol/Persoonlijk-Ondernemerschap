...
$opts['tb'] = 'teamspiegel01_historie';

$opts['key'] = 'teamID'; // Primary key checked

$opts['key_type'] = 'int';

$opts['sort_field'] = array('orgID','datum');
...
echo '=> Her-bewerking van TEAM ontwikkel rapportage  - Verwijder (delete) een van de TEAMS - Het nieuwe TEAM ontwikkel Spiegel rapport zal binnen 20 minuten klaar zijn. Alle PDF rapporten dienen opnieuw aangemaakt te worden.';

$main_table = 'teamspiegel01_historie';
