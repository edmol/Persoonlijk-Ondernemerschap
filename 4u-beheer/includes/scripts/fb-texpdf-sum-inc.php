...
$file0 = $dir.'po0-summary-rapport.tex';
$file = $dir.'po2-summary-rapport.tex';
$file2 = $dir.'po1-summary-rapport.tex';
$file3 =$dir.'po3-summary-rapport.tex';
$file4 =$dir.'po4-summary-rapport.tex';
$newname = $dirtoken.'-verkort'.'.pdf';
...
if(file_exists($file0))
	{
		...
		//
		system("pdflatex po0-summary-rapport.tex >/dev/null");
		system("pdflatex po0-summary-rapport.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po0-summary-rapport.pdf", $newname);
		//
		...
		$boodschap = "Verkort spiegel rapport is beschikbaar";
	} else 
	if(file_exists($file))
	{
		chdir($dir);
		...
		// Twee keer pdflatex om de toc goed in het document te krijgen
		//
		system("pdflatex po2-summary-rapport.tex >/dev/null");
		system("pdflatex po2-summary-rapport.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po2-summary-rapport.pdf", $newname);
		//
		// Rapport heeft nu een nieuwe onderscheidende naam zodat er een kopie gemaakt kan worden
		//
		//system("rm -r *.png");
	...
	if(file_exists($file2))
	{
		...
		// Twee keer pdflatex om de toc goed in het document te krijgen
		//
		system("pdflatex po1-summary-rapport.tex >/dev/null");
		system("pdflatex po1-summary-rapport.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po1-summary-rapport.pdf", $newname);
		//
		// Rapport heeft nu een nieuwe onderscheidende naam zodat er een kopie gemaakt kan worden
		//
		//system("rm -r *.png");
	...
	if(file_exists($file3))
	{
		...
		// Twee keer pdflatex om de toc goed in het document te krijgen
		//
		system("pdflatex po3-summary-rapport.tex >/dev/null");
		system("pdflatex po3-summary-rapport.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po3-summary-rapport.pdf", $newname);
		//
		// Rapport heeft nu een nieuwe onderscheidende naam zodat er een kopie gemaakt kan worden
		//
		//system("rm -r *.png");
		...
		//
		// system("rm -r *.pdf");
		$boodschap = "Verkort spiegel rapport is beschikbaar, navigeer terug om naar menu te gaan.";
	} else
	if(file_exists($file4))
	{
		...
		// Twee keer pdflatex om de toc goed in het document te krijgen
		//
		system("pdflatex po4-summary-rapport.tex >/dev/null");
		system("pdflatex po4-summary-rapport.tex >/dev/null");
		//
		//  Feedback spiegel is nu aangemaakt en voorzien van een TOC
		//	
		rename("po4-summary-rapport.pdf", $newname);
		//
		// Rapport heeft nu een nieuwe onderscheidende naam zodat er een kopie gemaakt kan worden
		//
		//system("rm -r *.png");
