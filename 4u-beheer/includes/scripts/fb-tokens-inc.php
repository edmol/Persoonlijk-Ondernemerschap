...
$validator->addValidation("f2vnaam","req","Graag voornaam van de tweede feedback gever invullen.");
$validator->addValidation("f2anaam","req","Graag de achternaam van de tweede feedback invullen.");
$validator->addValidation("f2email","email","Het e-mail adres van de tweede feedback gever is niet juist.");
$validator->addValidation("f2email","req","Graag e-mail adres van de tweede feedback gever invullen.");
...
$rf1sex   = $_POST['f1sex'];
//*********************************************************************
//  FEEDBACK 2 - Haal variabelen op en verwijder spaties uit voornaam
//**********************************************************************
$f2vnaam = str_replace(" ","",$_POST['f2vnaam']);
$f2anaam = $_POST['f2anaam'];
...
$f2token = $f2vnaam.'3'.date("Ymd").date("His");
//**********************************************************
...
mysql_select_db("potoets");
		...
		//**********************************************************************
		$order1 = "INSERT INTO $tokentabel (firstname,lastname,email,emailstatus,token,attribute_1,attribute_2,attribute_3,attribute_4,attribute_5,attribute_6,attribute_7) VALUES('$rvnaam','$ranaam','$remail','OK','$rtoken','r','$rvnaam','$f1token','$f2token','$rsex','$maakdir','2')";  
//**********************************************************************
...
//***********************************************************************
		...
		//***********************************************************************
		// NU FEEDBACK TOKENS AANMAKEN
		//***********************************************************************
		$exist = "DELETE FROM $tokentabel WHERE token='$f1token'";
		$existresult = mysql_query($exist);
		$order1 = "INSERT INTO $tokentabel (firstname,lastname,email,emailstatus,token,attribute_1,attribute_2,attribute_3,attribute_4,attribute_5,attribute_6,attribute_7) VALUES('$f1vnaam','$f1anaam','$f1email','OK','$f1token','f','$rvnaam','$rtoken','$f2token','$rsex','$maakdir','2')";
		$result = mysql_query($order1);
		//
		$exist = "DELETE FROM $tokentabel WHERE token='$f2token'";
		$existresult = mysql_query($exist);
		$order1 = "INSERT INTO $tokentabel (firstname,lastname,email,emailstatus,token,attribute_1,attribute_2,attribute_3,attribute_4,attribute_5,attribute_6,attribute_7) VALUES('$f2vnaam','$f2anaam','$f2email','OK','$f2token','f','$rvnaam','$rtoken','$f1token','$rsex','$maakdir','2')";
		$result = mysql_query($order1);
		//
		//************************************************************************************
		...
		$mes03 = "Als respondent heeft u gekozen voor de volgende feedback gevers :";
		$mes04 = "Feedbackgever 1 voor ".$rvnaam." : ".$f1vnaam." ".$f1anaam;
		$mes05 = "Feedbackgever 2 voor ".$rvnaam." : ".$f2vnaam." ".$f2anaam;
...
$mes05 = "Om te beginnen met de 100 stellingen klikt u op onderstaande link.";
		...
		$subject = "Vertrouwen - Innovatie - Spiegelen! Uw instructies voor het geven van feedback voor ".$rvnaam." ".$ranaam."."; 
		$mes01 = "Hallo ".$f2vnaam.".";
		$mes02 = "U ontvangt deze mail omdat ".$rvnaam." ".$ranaam." een aanvraag voor de individuele ontwikkelspiegel rapport gedaan heeft, en u heeft opgegeven als feedbackgever.";
		$mes03 = "Als feedbackgever wordt u ook verzocht om net als ".$rvnaam." ".$ranaam." 100 stellingen in te vullen.";
		$mes04 = "Zodra u en de anderen feed back gevers de stellingen hebben ingevuld, zullen wij zo snel mogelijk het rapport maken en met ".$rvnaam." ".$ranaam." bespreken.";
$mes05 = "Om te beginnen met de 100 stellingen klikt u op onderstaande link.";	
		$mes06 = "Vertrouwen - Innovatie - Spiegelen. http://".$omgeving."/index.php?sid=".$survey."&token=".$f2token;
		$mes07 = "";
		$mes08 = "Met vriendelijke groeten,";
		$mes09 = "4U CHANGE - Vertrouwen - Innovatie - Spiegelen";
		$mes10 = "Voor vragen kun u een mail sturen naar helpdesk@4u-change.com";
...
<tr>
<tr>
<td align='right' class='normal_field'>Voornaam van de tweede feedback gever</td>
<td class='element_label'>
<input type='text' name='f2vnaam' size='40'>
</td>
</tr>
<tr>
<td align='right' class='normal_field'>Achternaam van de tweede feedback gever</td>
<td class='element_label'>
<input type='text' name='f2anaam' size='40'>
</td>
</tr>
<tr>
<td align='right' class='normal_field'>Email adres van de tweede feedback gever</td>
<td class='element_label'>
<input type='text' name='f2email' size='40'>
</td>
</tr>
<tr>
<tr>
